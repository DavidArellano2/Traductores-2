...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression','proyecto.py',6),
  ('expression -> expression MINUS term','expression',3,'p_expression','proyecto.py',7),
  ...
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','proyecto.py',31),
]
